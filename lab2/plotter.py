...
def plot_time_complexity(
    ...
    nfdh_times: Sequence[float],
    ffdh_times: Sequence[float],
    *,
    ...
    plt.plot(m_values, nfdh_times, marker="o", label="NFDH")
    plt.plot(m_values, ffdh_times, marker="s", label="FFDH")
    plt.xlabel("m (number of tasks)")
    plt.ylabel("Runtime, seconds")
    plt.title("Time Complexity: NFDH vs FFDH")
