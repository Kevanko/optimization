...
set title "Среднее время восстановления (N = 8192, {/Symbol m} = 1 1/ч, m = 1)"
...
plot "../data/T_lam.dat" using 1:2 title "{/Symbol l} = 10^{-5} 1/ч" with linespoints pt 1 lw 1.5, \
     ...
     "../data/T_lam.dat" using 1:5 title "{/Symbol l} = 10^{-8} 1/ч" with linespoints pt 4 lw 1.5, \
     "../data/T_lam.dat" using 1:6 title "{/Symbol l} = 10^{-9} 1/ч" with linespoints pt 5 lw 1.5
